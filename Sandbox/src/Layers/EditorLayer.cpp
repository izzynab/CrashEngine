...
namespace CrashEngine {
		...
		: Layer("Example")
	{
		...
		for (int y = 0; y < 100; y++)
		{
			...
			//Application::Get().GetDebugger().AddPoint(glm::vec3(y * 3, 0, 0), glm::vec3(0), glm::vec3(1, 0, 0), 1, PointType::Cube);
		}
	...
	void Editor::OnUpdate(Timestep ts)
	{
		...
		for (int y = 0; y < 100; y++)
		{
			//Application::Get().GetDebugger().DrawUpdatePoint(glm::vec3(y * 3, 0, 0), glm::vec3(0), glm::vec3(1, 0, 0), 1, PointType::Sphere);
		}
