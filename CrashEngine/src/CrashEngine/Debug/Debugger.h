...
namespace CrashEngine {
	...
	public:
		...
		inline void DrawFrustum(const glm::mat4& projectionView) { debugLines->DrawFrustum(projectionView); }
		...
		inline void DrawUpdatePoint(glm::vec3 position, glm::vec3 color = glm::vec3(1), float size = 1, PointType type = PointType::Cube, glm::vec3 rotation = glm::vec3(0)) { debugPoints->DrawUpdatePoint(position, rotation, color, size, type); }
